/**
 * Async section for /insights/genres — the slow genre breakdown query streams
 * behind the page's Suspense boundary. Lives in its own file (not page.tsx)
 * because Next.js route files may only export route-segment symbols, and this
 * component must stay importable for unit tests — jsdom's synchronous render
 * cannot resolve an async child inside <Suspense>.
 */
